...
class bridgegroup_nsip6_binding_response extends base_response
{
	public bridgegroup_nsip6_binding[] bridgegroup_nsip6_binding;
}
/**
	* Binding class showing the nsip6 that can be bound to bridgegroup.
	*/

public class bridgegroup_nsip6_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		bridgegroup_nsip6_binding_response result = (bridgegroup_nsip6_binding_response) service.get_payload_formatter().string_to_resource(bridgegroup_nsip6_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, bridgegroup_nsip6_binding resource) throws Exception {
		bridgegroup_nsip6_binding updateresource = new bridgegroup_nsip6_binding();
	...
	public static base_responses add(nitro_service client, bridgegroup_nsip6_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			bridgegroup_nsip6_binding updateresources[] = new bridgegroup_nsip6_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new bridgegroup_nsip6_binding();
	...
	public static base_response delete(nitro_service client, bridgegroup_nsip6_binding resource) throws Exception {
		bridgegroup_nsip6_binding deleteresource = new bridgegroup_nsip6_binding();
	...
	public static base_responses delete(nitro_service client, bridgegroup_nsip6_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			bridgegroup_nsip6_binding deleteresources[] = new bridgegroup_nsip6_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new bridgegroup_nsip6_binding();
	...
	*/
	public static bridgegroup_nsip6_binding[] get_filtered(nitro_service service, Long id, String filter) throws Exception{
		bridgegroup_nsip6_binding obj = new bridgegroup_nsip6_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
		bridgegroup_nsip6_binding[] response = (bridgegroup_nsip6_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static bridgegroup_nsip6_binding[] get_filtered(nitro_service service, Long id, filtervalue[] filter) throws Exception{
		bridgegroup_nsip6_binding obj = new bridgegroup_nsip6_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, Long id) throws Exception{
		...
		bridgegroup_nsip6_binding response[] = (bridgegroup_nsip6_binding[]) obj.get_resources(service,option);
		if (response != null) {
