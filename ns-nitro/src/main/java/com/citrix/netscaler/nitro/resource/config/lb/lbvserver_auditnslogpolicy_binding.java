...
class lbvserver_auditnslogpolicy_binding_response extends base_response
{
	public lbvserver_auditnslogpolicy_binding[] lbvserver_auditnslogpolicy_binding;
}
/**
	* Binding class showing the auditnslogpolicy that can be bound to lbvserver.
	*/

public class lbvserver_auditnslogpolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		lbvserver_auditnslogpolicy_binding_response result = (lbvserver_auditnslogpolicy_binding_response) service.get_payload_formatter().string_to_resource(lbvserver_auditnslogpolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, lbvserver_auditnslogpolicy_binding resource) throws Exception {
		lbvserver_auditnslogpolicy_binding updateresource = new lbvserver_auditnslogpolicy_binding();
	...
	public static base_responses add(nitro_service client, lbvserver_auditnslogpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			lbvserver_auditnslogpolicy_binding updateresources[] = new lbvserver_auditnslogpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new lbvserver_auditnslogpolicy_binding();
	...
	public static base_response delete(nitro_service client, lbvserver_auditnslogpolicy_binding resource) throws Exception {
		lbvserver_auditnslogpolicy_binding deleteresource = new lbvserver_auditnslogpolicy_binding();
	...
	public static base_responses delete(nitro_service client, lbvserver_auditnslogpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			lbvserver_auditnslogpolicy_binding deleteresources[] = new lbvserver_auditnslogpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new lbvserver_auditnslogpolicy_binding();
	...
	*/
	public static lbvserver_auditnslogpolicy_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		lbvserver_auditnslogpolicy_binding obj = new lbvserver_auditnslogpolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		lbvserver_auditnslogpolicy_binding[] response = (lbvserver_auditnslogpolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static lbvserver_auditnslogpolicy_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		lbvserver_auditnslogpolicy_binding obj = new lbvserver_auditnslogpolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		lbvserver_auditnslogpolicy_binding response[] = (lbvserver_auditnslogpolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
