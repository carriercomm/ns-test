...
class authenticationcertpolicy_vpnvserver_binding_response extends base_response
{
	public authenticationcertpolicy_vpnvserver_binding[] authenticationcertpolicy_vpnvserver_binding;
}
/**
	* Binding class showing the vpnvserver that can be bound to authenticationcertpolicy.
	*/

public class authenticationcertpolicy_vpnvserver_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		authenticationcertpolicy_vpnvserver_binding_response result = (authenticationcertpolicy_vpnvserver_binding_response) service.get_payload_formatter().string_to_resource(authenticationcertpolicy_vpnvserver_binding_response.class, response);
	...
	*/
	public static authenticationcertpolicy_vpnvserver_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		authenticationcertpolicy_vpnvserver_binding obj = new authenticationcertpolicy_vpnvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		authenticationcertpolicy_vpnvserver_binding[] response = (authenticationcertpolicy_vpnvserver_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static authenticationcertpolicy_vpnvserver_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		authenticationcertpolicy_vpnvserver_binding obj = new authenticationcertpolicy_vpnvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		authenticationcertpolicy_vpnvserver_binding response[] = (authenticationcertpolicy_vpnvserver_binding[]) obj.get_resources(service,option);
		if (response != null) {
