...
public class appqoeparameter extends base_resource
{
	...
	*/
	...
	/**
	* <pre>
	* File containing the customized response to be displayed when the ACTION in the AppQoE policy is set to NS.<br> Default value: "DEFAULT"<br> Minimum length =  1
	* </pre>
	*/
