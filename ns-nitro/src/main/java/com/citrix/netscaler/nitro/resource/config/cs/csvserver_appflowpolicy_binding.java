...
public class csvserver_appflowpolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		csvserver_appflowpolicy_binding_response result = (csvserver_appflowpolicy_binding_response) service.get_payload_formatter().string_to_resource(csvserver_appflowpolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, csvserver_appflowpolicy_binding resource) throws Exception {
		csvserver_appflowpolicy_binding updateresource = new csvserver_appflowpolicy_binding();
	...
	public static base_responses add(nitro_service client, csvserver_appflowpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			csvserver_appflowpolicy_binding updateresources[] = new csvserver_appflowpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new csvserver_appflowpolicy_binding();
	...
	public static base_response delete(nitro_service client, csvserver_appflowpolicy_binding resource) throws Exception {
		csvserver_appflowpolicy_binding deleteresource = new csvserver_appflowpolicy_binding();
	...
	public static base_responses delete(nitro_service client, csvserver_appflowpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			csvserver_appflowpolicy_binding deleteresources[] = new csvserver_appflowpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new csvserver_appflowpolicy_binding();
	...
	*/
	public static csvserver_appflowpolicy_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		csvserver_appflowpolicy_binding obj = new csvserver_appflowpolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		csvserver_appflowpolicy_binding[] response = (csvserver_appflowpolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static csvserver_appflowpolicy_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		csvserver_appflowpolicy_binding obj = new csvserver_appflowpolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		csvserver_appflowpolicy_binding response[] = (csvserver_appflowpolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
