...
class appfwpolicylabel_policybinding_binding_response extends base_response
{
	public appfwpolicylabel_policybinding_binding[] appfwpolicylabel_policybinding_binding;
}
/**
	* Binding class showing the policybinding that can be bound to appfwpolicylabel.
	*/

public class appfwpolicylabel_policybinding_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appfwpolicylabel_policybinding_binding_response result = (appfwpolicylabel_policybinding_binding_response) service.get_payload_formatter().string_to_resource(appfwpolicylabel_policybinding_binding_response.class, response);
	...
	*/
	public static appfwpolicylabel_policybinding_binding[] get_filtered(nitro_service service, String labelname, String filter) throws Exception{
		appfwpolicylabel_policybinding_binding obj = new appfwpolicylabel_policybinding_binding();
		obj.set_labelname(labelname);
		options option = new options();
		option.set_filter(filter);
		appfwpolicylabel_policybinding_binding[] response = (appfwpolicylabel_policybinding_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appfwpolicylabel_policybinding_binding[] get_filtered(nitro_service service, String labelname, filtervalue[] filter) throws Exception{
		appfwpolicylabel_policybinding_binding obj = new appfwpolicylabel_policybinding_binding();
		obj.set_labelname(labelname);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String labelname) throws Exception{
		...
		appfwpolicylabel_policybinding_binding response[] = (appfwpolicylabel_policybinding_binding[]) obj.get_resources(service,option);
		if (response != null) {
