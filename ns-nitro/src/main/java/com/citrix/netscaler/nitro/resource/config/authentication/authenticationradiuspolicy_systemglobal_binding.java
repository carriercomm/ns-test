...
class authenticationradiuspolicy_systemglobal_binding_response extends base_response
{
	public authenticationradiuspolicy_systemglobal_binding[] authenticationradiuspolicy_systemglobal_binding;
}
/**
	* Binding class showing the systemglobal that can be bound to authenticationradiuspolicy.
	*/

public class authenticationradiuspolicy_systemglobal_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		authenticationradiuspolicy_systemglobal_binding_response result = (authenticationradiuspolicy_systemglobal_binding_response) service.get_payload_formatter().string_to_resource(authenticationradiuspolicy_systemglobal_binding_response.class, response);
	...
	*/
	public static authenticationradiuspolicy_systemglobal_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		authenticationradiuspolicy_systemglobal_binding obj = new authenticationradiuspolicy_systemglobal_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		authenticationradiuspolicy_systemglobal_binding[] response = (authenticationradiuspolicy_systemglobal_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static authenticationradiuspolicy_systemglobal_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		authenticationradiuspolicy_systemglobal_binding obj = new authenticationradiuspolicy_systemglobal_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		authenticationradiuspolicy_systemglobal_binding response[] = (authenticationradiuspolicy_systemglobal_binding[]) obj.get_resources(service,option);
		if (response != null) {
