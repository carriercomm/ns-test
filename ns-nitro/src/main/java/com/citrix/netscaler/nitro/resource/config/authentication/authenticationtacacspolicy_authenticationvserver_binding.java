...
class authenticationtacacspolicy_authenticationvserver_binding_response extends base_response
{
	public authenticationtacacspolicy_authenticationvserver_binding[] authenticationtacacspolicy_authenticationvserver_binding;
}
/**
	* Binding class showing the authenticationvserver that can be bound to authenticationtacacspolicy.
	*/

public class authenticationtacacspolicy_authenticationvserver_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		authenticationtacacspolicy_authenticationvserver_binding_response result = (authenticationtacacspolicy_authenticationvserver_binding_response) service.get_payload_formatter().string_to_resource(authenticationtacacspolicy_authenticationvserver_binding_response.class, response);
	...
	*/
	public static authenticationtacacspolicy_authenticationvserver_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		authenticationtacacspolicy_authenticationvserver_binding obj = new authenticationtacacspolicy_authenticationvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		authenticationtacacspolicy_authenticationvserver_binding[] response = (authenticationtacacspolicy_authenticationvserver_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static authenticationtacacspolicy_authenticationvserver_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		authenticationtacacspolicy_authenticationvserver_binding obj = new authenticationtacacspolicy_authenticationvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		authenticationtacacspolicy_authenticationvserver_binding response[] = (authenticationtacacspolicy_authenticationvserver_binding[]) obj.get_resources(service,option);
		if (response != null) {
