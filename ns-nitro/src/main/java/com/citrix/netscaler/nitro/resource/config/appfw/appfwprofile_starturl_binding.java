...
class appfwprofile_starturl_binding_response extends base_response
{
	public appfwprofile_starturl_binding[] appfwprofile_starturl_binding;
}
/**
	* Binding class showing the starturl that can be bound to appfwprofile.
	*/

public class appfwprofile_starturl_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appfwprofile_starturl_binding_response result = (appfwprofile_starturl_binding_response) service.get_payload_formatter().string_to_resource(appfwprofile_starturl_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, appfwprofile_starturl_binding resource) throws Exception {
		appfwprofile_starturl_binding updateresource = new appfwprofile_starturl_binding();
	...
	public static base_responses add(nitro_service client, appfwprofile_starturl_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_starturl_binding updateresources[] = new appfwprofile_starturl_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new appfwprofile_starturl_binding();
				updateresources[i].name = resources[i].name;
				updateresources[i].starturl = resources[i].starturl;
	...
	public static base_response delete(nitro_service client, appfwprofile_starturl_binding resource) throws Exception {
		appfwprofile_starturl_binding deleteresource = new appfwprofile_starturl_binding();
		deleteresource.name = resource.name;
		deleteresource.starturl = resource.starturl;
		return deleteresource.delete_resource(client);
	}

	public static base_responses delete(nitro_service client, appfwprofile_starturl_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_starturl_binding deleteresources[] = new appfwprofile_starturl_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new appfwprofile_starturl_binding();
	...
	*/
	public static appfwprofile_starturl_binding[] get(nitro_service service, String name) throws Exception{
	...
	*/
	public static appfwprofile_starturl_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		appfwprofile_starturl_binding obj = new appfwprofile_starturl_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		appfwprofile_starturl_binding[] response = (appfwprofile_starturl_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appfwprofile_starturl_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		appfwprofile_starturl_binding obj = new appfwprofile_starturl_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		appfwprofile_starturl_binding response[] = (appfwprofile_starturl_binding[]) obj.get_resources(service,option);
		if (response != null) {
