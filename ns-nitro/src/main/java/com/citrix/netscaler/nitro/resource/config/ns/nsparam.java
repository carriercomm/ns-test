...
public class nsparam extends base_resource
{
	...
	private String aftpallowrandomsourceport;
	private Integer[] icaports;

	/**
	* <pre>
	* HTTP ports on the web server. This allows the system to perform connection off-load for any client request that has a destination port matching one of these configured ports.<br> Minimum value =  1
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Maximum number of connections that will be made from the appliance to the web server(s) attached to it. The value entered here is applied globally to all attached servers.<br> Minimum value =  0<br> Maximum value =  4294967294
	* </pre>
	*/
...
* If the CIP header is not specified, the value that has been set will be used as the client IP header.<br> Possible values = ENABLED, DISABLED
	...
	*/
	...
	/**
	* <pre>
	* Minimum path MTU value that NetScaler will process in the ICMP fragmentation needed message. If the ICMP message contains a value less than this value, then this value is used instead.<br> Default value: 576<br> Minimum value =  168<br> Maximum value =  1500
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Interval, in minutes, for flushing the PMTU entries.<br> Default value: 10<br> Minimum value =  1<br> Maximum value =  1440
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Percentage of shared quota to be granted at a time for maxClient.<br> Default value: 10<br> Minimum value =  0<br> Maximum value =  100
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Percentage of maxClient to be given to PEs.<br> Default value: 80<br> Minimum value =  0<br> Maximum value =  100
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Percentage of shared quota to be granted at a time for spillover.<br> Default value: 10<br> Minimum value =  0<br> Maximum value =  100
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Percentage of maximum limit to be given to PEs.<br> Default value: 80<br> Minimum value =  0<br> Maximum value =  100
	* </pre>
	*/
	...
	* </pre>
	*/
	public void set_internaluserlogin(String internaluserlogin) throws Exception{
	...
	* </pre>
	*/
	public String get_internaluserlogin() throws Exception {
		return this.internaluserlogin;
	}
	...
	* </pre>
	*/
	public void set_aftpallowrandomsourceport(String aftpallowrandomsourceport) throws Exception{
	...
	* </pre>
	*/
	public String get_aftpallowrandomsourceport() throws Exception {
		return this.aftpallowrandomsourceport;
	}

	/**
	* <pre>
	* The ICA ports on the Web server. This allows the system to perform connection off-load for any
                      client request that has a destination port matching one of these configured ports.<br> Minimum value =  1
	* </pre>
	*/
	public void set_icaports(Integer[] icaports) throws Exception{
	...
	* </pre>
	*/
	public Integer[] get_icaports() throws Exception {
		return this.icaports;
	}
