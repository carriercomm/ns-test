...
class dnspolicy_dnspolicylabel_binding_response extends base_response
{
	public dnspolicy_dnspolicylabel_binding[] dnspolicy_dnspolicylabel_binding;
}
/**
	* Binding class showing the dnspolicylabel that can be bound to dnspolicy.
	*/

public class dnspolicy_dnspolicylabel_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		dnspolicy_dnspolicylabel_binding_response result = (dnspolicy_dnspolicylabel_binding_response) service.get_payload_formatter().string_to_resource(dnspolicy_dnspolicylabel_binding_response.class, response);
	...
	*/
	public static dnspolicy_dnspolicylabel_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		dnspolicy_dnspolicylabel_binding obj = new dnspolicy_dnspolicylabel_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		dnspolicy_dnspolicylabel_binding[] response = (dnspolicy_dnspolicylabel_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static dnspolicy_dnspolicylabel_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		dnspolicy_dnspolicylabel_binding obj = new dnspolicy_dnspolicylabel_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		dnspolicy_dnspolicylabel_binding response[] = (dnspolicy_dnspolicylabel_binding[]) obj.get_resources(service,option);
		if (response != null) {
