...
class appfwpolicy_lbvserver_binding_response extends base_response
{
	public appfwpolicy_lbvserver_binding[] appfwpolicy_lbvserver_binding;
}
/**
	* Binding class showing the lbvserver that can be bound to appfwpolicy.
	*/

public class appfwpolicy_lbvserver_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appfwpolicy_lbvserver_binding_response result = (appfwpolicy_lbvserver_binding_response) service.get_payload_formatter().string_to_resource(appfwpolicy_lbvserver_binding_response.class, response);
	...
	*/
	public static appfwpolicy_lbvserver_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		appfwpolicy_lbvserver_binding obj = new appfwpolicy_lbvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		appfwpolicy_lbvserver_binding[] response = (appfwpolicy_lbvserver_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appfwpolicy_lbvserver_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		appfwpolicy_lbvserver_binding obj = new appfwpolicy_lbvserver_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		appfwpolicy_lbvserver_binding response[] = (appfwpolicy_lbvserver_binding[]) obj.get_resources(service,option);
		if (response != null) {
