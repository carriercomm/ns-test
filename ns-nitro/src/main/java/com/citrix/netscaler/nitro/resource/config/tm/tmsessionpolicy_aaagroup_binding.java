...
class tmsessionpolicy_aaagroup_binding_response extends base_response
{
	public tmsessionpolicy_aaagroup_binding[] tmsessionpolicy_aaagroup_binding;
}
/**
	* Binding class showing the aaagroup that can be bound to tmsessionpolicy.
	*/

public class tmsessionpolicy_aaagroup_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		tmsessionpolicy_aaagroup_binding_response result = (tmsessionpolicy_aaagroup_binding_response) service.get_payload_formatter().string_to_resource(tmsessionpolicy_aaagroup_binding_response.class, response);
