...
public class rewritepolicy_rewriteglobal_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		rewritepolicy_rewriteglobal_binding_response result = (rewritepolicy_rewriteglobal_binding_response) service.get_payload_formatter().string_to_resource(rewritepolicy_rewriteglobal_binding_response.class, response);
	...
	*/
	public static rewritepolicy_rewriteglobal_binding[] get(nitro_service service, String name) throws Exception{
		...
		obj.set_name(name);
		rewritepolicy_rewriteglobal_binding response[] = (rewritepolicy_rewriteglobal_binding[]) obj.get_resources(service);
		return response;
	}
	...
	*/
	public static rewritepolicy_rewriteglobal_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		rewritepolicy_rewriteglobal_binding obj = new rewritepolicy_rewriteglobal_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		rewritepolicy_rewriteglobal_binding[] response = (rewritepolicy_rewriteglobal_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static rewritepolicy_rewriteglobal_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		rewritepolicy_rewriteglobal_binding obj = new rewritepolicy_rewriteglobal_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		rewritepolicy_rewriteglobal_binding response[] = (rewritepolicy_rewriteglobal_binding[]) obj.get_resources(service,option);
		if (response != null) {
