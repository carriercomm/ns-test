...
class tmtrafficpolicy_tmglobal_binding_response extends base_response
{
	public tmtrafficpolicy_tmglobal_binding[] tmtrafficpolicy_tmglobal_binding;
}
/**
	* Binding class showing the tmglobal that can be bound to tmtrafficpolicy.
	*/

public class tmtrafficpolicy_tmglobal_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		tmtrafficpolicy_tmglobal_binding_response result = (tmtrafficpolicy_tmglobal_binding_response) service.get_payload_formatter().string_to_resource(tmtrafficpolicy_tmglobal_binding_response.class, response);
	...
	*/
	public static tmtrafficpolicy_tmglobal_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		tmtrafficpolicy_tmglobal_binding obj = new tmtrafficpolicy_tmglobal_binding();
		obj.set_name(name);
	...
	*/
	public static tmtrafficpolicy_tmglobal_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		tmtrafficpolicy_tmglobal_binding obj = new tmtrafficpolicy_tmglobal_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		tmtrafficpolicy_tmglobal_binding response[] = (tmtrafficpolicy_tmglobal_binding[]) obj.get_resources(service,option);
		if (response != null) {
