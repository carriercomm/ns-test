...
In the configuration utility, select Network VServer to enter a range.<br> Default value: 1<br> Minimum value =  1
	...
	*/
	...
	/**
	* <pre>
	* Maximum number of concurrent user sessions allowed on this virtual server. The actual number of users allowed to log on to this virtual server depends on the total number of user licenses.<br> Minimum value =  0<br> Maximum value =  65535
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* The owner node.<br> Default value: 255<br> Minimum value =  0<br> Maximum value =  31
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* The backup node.<br> Default value: 255<br> Minimum value =  0<br> Maximum value =  31
	* </pre>
	*/
