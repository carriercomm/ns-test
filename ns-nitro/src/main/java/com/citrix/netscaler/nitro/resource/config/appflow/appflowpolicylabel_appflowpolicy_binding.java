...
class appflowpolicylabel_appflowpolicy_binding_response extends base_response
{
	public appflowpolicylabel_appflowpolicy_binding[] appflowpolicylabel_appflowpolicy_binding;
}
/**
...
public class appflowpolicylabel_appflowpolicy_binding extends base_resource
{
	...
	*/
	...
	/**
	* <pre>
	* Name of an AppFlow policy label.<br> Minimum length =  1
	* </pre>
	*/
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appflowpolicylabel_appflowpolicy_binding_response result = (appflowpolicylabel_appflowpolicy_binding_response) service.get_payload_formatter().string_to_resource(appflowpolicylabel_appflowpolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, appflowpolicylabel_appflowpolicy_binding resource) throws Exception {
		appflowpolicylabel_appflowpolicy_binding updateresource = new appflowpolicylabel_appflowpolicy_binding();
	...
	public static base_responses add(nitro_service client, appflowpolicylabel_appflowpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appflowpolicylabel_appflowpolicy_binding updateresources[] = new appflowpolicylabel_appflowpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new appflowpolicylabel_appflowpolicy_binding();
	...
	public static base_response delete(nitro_service client, appflowpolicylabel_appflowpolicy_binding resource) throws Exception {
		appflowpolicylabel_appflowpolicy_binding deleteresource = new appflowpolicylabel_appflowpolicy_binding();
	...
	public static base_responses delete(nitro_service client, appflowpolicylabel_appflowpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appflowpolicylabel_appflowpolicy_binding deleteresources[] = new appflowpolicylabel_appflowpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new appflowpolicylabel_appflowpolicy_binding();
	...
	*/
	public static appflowpolicylabel_appflowpolicy_binding[] get_filtered(nitro_service service, String labelname, String filter) throws Exception{
		appflowpolicylabel_appflowpolicy_binding obj = new appflowpolicylabel_appflowpolicy_binding();
		obj.set_labelname(labelname);
		options option = new options();
		option.set_filter(filter);
		appflowpolicylabel_appflowpolicy_binding[] response = (appflowpolicylabel_appflowpolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appflowpolicylabel_appflowpolicy_binding[] get_filtered(nitro_service service, String labelname, filtervalue[] filter) throws Exception{
		appflowpolicylabel_appflowpolicy_binding obj = new appflowpolicylabel_appflowpolicy_binding();
		obj.set_labelname(labelname);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String labelname) throws Exception{
		...
		appflowpolicylabel_appflowpolicy_binding response[] = (appflowpolicylabel_appflowpolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
