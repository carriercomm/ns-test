...
class appfwprofile_contenttype_binding_response extends base_response
{
	public appfwprofile_contenttype_binding[] appfwprofile_contenttype_binding;
}
/**
	* Binding class showing the contenttype that can be bound to appfwprofile.
	*/

public class appfwprofile_contenttype_binding extends base_resource
{
	...
	* </pre>
	*/
	public void set_contenttype(String contenttype) throws Exception{
	...
	* </pre>
	*/
	public String get_contenttype() throws Exception {
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appfwprofile_contenttype_binding_response result = (appfwprofile_contenttype_binding_response) service.get_payload_formatter().string_to_resource(appfwprofile_contenttype_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, appfwprofile_contenttype_binding resource) throws Exception {
		appfwprofile_contenttype_binding updateresource = new appfwprofile_contenttype_binding();
	...
	public static base_responses add(nitro_service client, appfwprofile_contenttype_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_contenttype_binding updateresources[] = new appfwprofile_contenttype_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new appfwprofile_contenttype_binding();
				updateresources[i].name = resources[i].name;
				updateresources[i].contenttype = resources[i].contenttype;
	...
	public static base_response delete(nitro_service client, appfwprofile_contenttype_binding resource) throws Exception {
		appfwprofile_contenttype_binding deleteresource = new appfwprofile_contenttype_binding();
		deleteresource.name = resource.name;
		deleteresource.contenttype = resource.contenttype;
		return deleteresource.delete_resource(client);
	}

	public static base_responses delete(nitro_service client, appfwprofile_contenttype_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_contenttype_binding deleteresources[] = new appfwprofile_contenttype_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new appfwprofile_contenttype_binding();
				deleteresources[i].name = resources[i].name;
				deleteresources[i].contenttype = resources[i].contenttype;
			}
	...
	*/
	public static appfwprofile_contenttype_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		appfwprofile_contenttype_binding obj = new appfwprofile_contenttype_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		appfwprofile_contenttype_binding[] response = (appfwprofile_contenttype_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appfwprofile_contenttype_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		appfwprofile_contenttype_binding obj = new appfwprofile_contenttype_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		appfwprofile_contenttype_binding response[] = (appfwprofile_contenttype_binding[]) obj.get_resources(service,option);
		if (response != null) {
