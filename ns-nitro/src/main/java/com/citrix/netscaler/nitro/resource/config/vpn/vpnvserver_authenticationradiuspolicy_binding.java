...
class vpnvserver_authenticationradiuspolicy_binding_response extends base_response
{
	public vpnvserver_authenticationradiuspolicy_binding[] vpnvserver_authenticationradiuspolicy_binding;
}
/**
	* Binding class showing the authenticationradiuspolicy that can be bound to vpnvserver.
	*/

public class vpnvserver_authenticationradiuspolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		vpnvserver_authenticationradiuspolicy_binding_response result = (vpnvserver_authenticationradiuspolicy_binding_response) service.get_payload_formatter().string_to_resource(vpnvserver_authenticationradiuspolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, vpnvserver_authenticationradiuspolicy_binding resource) throws Exception {
		vpnvserver_authenticationradiuspolicy_binding updateresource = new vpnvserver_authenticationradiuspolicy_binding();
	...
	public static base_responses add(nitro_service client, vpnvserver_authenticationradiuspolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			vpnvserver_authenticationradiuspolicy_binding updateresources[] = new vpnvserver_authenticationradiuspolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new vpnvserver_authenticationradiuspolicy_binding();
	...
	public static base_response delete(nitro_service client, vpnvserver_authenticationradiuspolicy_binding resource) throws Exception {
		vpnvserver_authenticationradiuspolicy_binding deleteresource = new vpnvserver_authenticationradiuspolicy_binding();
	...
	public static base_responses delete(nitro_service client, vpnvserver_authenticationradiuspolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			vpnvserver_authenticationradiuspolicy_binding deleteresources[] = new vpnvserver_authenticationradiuspolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new vpnvserver_authenticationradiuspolicy_binding();
	...
	*/
	public static vpnvserver_authenticationradiuspolicy_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		vpnvserver_authenticationradiuspolicy_binding obj = new vpnvserver_authenticationradiuspolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		vpnvserver_authenticationradiuspolicy_binding[] response = (vpnvserver_authenticationradiuspolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static vpnvserver_authenticationradiuspolicy_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		vpnvserver_authenticationradiuspolicy_binding obj = new vpnvserver_authenticationradiuspolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		vpnvserver_authenticationradiuspolicy_binding response[] = (vpnvserver_authenticationradiuspolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
