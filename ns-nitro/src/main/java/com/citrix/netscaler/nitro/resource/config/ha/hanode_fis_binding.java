...
class hanode_fis_binding_response extends base_response
{
	public hanode_fis_binding[] hanode_fis_binding;
}
/**
...
public class hanode_fis_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		hanode_fis_binding_response result = (hanode_fis_binding_response) service.get_payload_formatter().string_to_resource(hanode_fis_binding_response.class, response);
	...
	*/
	public static hanode_fis_binding[] get(nitro_service service, Long id) throws Exception{
	...
	*/
	public static hanode_fis_binding[] get_filtered(nitro_service service, Long id, String filter) throws Exception{
		hanode_fis_binding obj = new hanode_fis_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
		hanode_fis_binding[] response = (hanode_fis_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static hanode_fis_binding[] get_filtered(nitro_service service, Long id, filtervalue[] filter) throws Exception{
		hanode_fis_binding obj = new hanode_fis_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, Long id) throws Exception{
		...
		hanode_fis_binding response[] = (hanode_fis_binding[]) obj.get_resources(service,option);
		if (response != null) {
