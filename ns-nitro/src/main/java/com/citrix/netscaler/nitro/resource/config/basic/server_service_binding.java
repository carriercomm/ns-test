...
public class server_service_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		server_service_binding_response result = (server_service_binding_response) service.get_payload_formatter().string_to_resource(server_service_binding_response.class, response);
	...
	*/
	public static server_service_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		server_service_binding obj = new server_service_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		server_service_binding[] response = (server_service_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static server_service_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		server_service_binding obj = new server_service_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		server_service_binding response[] = (server_service_binding[]) obj.get_resources(service,option);
		if (response != null) {
