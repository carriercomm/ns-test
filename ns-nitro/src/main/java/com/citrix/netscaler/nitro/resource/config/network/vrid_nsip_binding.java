...
class vrid_nsip_binding_response extends base_response
{
	public vrid_nsip_binding[] vrid_nsip_binding;
}
/**
	* Binding class showing the nsip that can be bound to vrid.
	*/

public class vrid_nsip_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		vrid_nsip_binding_response result = (vrid_nsip_binding_response) service.get_payload_formatter().string_to_resource(vrid_nsip_binding_response.class, response);
	...
	*/
	public static vrid_nsip_binding[] get(nitro_service service, Long id) throws Exception{
	...
	*/
	public static vrid_nsip_binding[] get_filtered(nitro_service service, Long id, String filter) throws Exception{
		vrid_nsip_binding obj = new vrid_nsip_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
		vrid_nsip_binding[] response = (vrid_nsip_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static vrid_nsip_binding[] get_filtered(nitro_service service, Long id, filtervalue[] filter) throws Exception{
		vrid_nsip_binding obj = new vrid_nsip_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, Long id) throws Exception{
		...
		vrid_nsip_binding response[] = (vrid_nsip_binding[]) obj.get_resources(service,option);
		if (response != null) {
