...
class auditnslogpolicy_aaauser_binding_response extends base_response
{
	public auditnslogpolicy_aaauser_binding[] auditnslogpolicy_aaauser_binding;
}
/**
	* Binding class showing the aaauser that can be bound to auditnslogpolicy.
	*/

public class auditnslogpolicy_aaauser_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		auditnslogpolicy_aaauser_binding_response result = (auditnslogpolicy_aaauser_binding_response) service.get_payload_formatter().string_to_resource(auditnslogpolicy_aaauser_binding_response.class, response);
	...
	*/
	public static auditnslogpolicy_aaauser_binding[] get(nitro_service service, String name) throws Exception{
	...
	*/
	public static auditnslogpolicy_aaauser_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		auditnslogpolicy_aaauser_binding obj = new auditnslogpolicy_aaauser_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		auditnslogpolicy_aaauser_binding[] response = (auditnslogpolicy_aaauser_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static auditnslogpolicy_aaauser_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		auditnslogpolicy_aaauser_binding obj = new auditnslogpolicy_aaauser_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		auditnslogpolicy_aaauser_binding response[] = (auditnslogpolicy_aaauser_binding[]) obj.get_resources(service,option);
		if (response != null) {
