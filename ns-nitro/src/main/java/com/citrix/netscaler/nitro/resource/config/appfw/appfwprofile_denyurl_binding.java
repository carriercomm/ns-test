...
class appfwprofile_denyurl_binding_response extends base_response
{
	public appfwprofile_denyurl_binding[] appfwprofile_denyurl_binding;
}
/**
...
public class appfwprofile_denyurl_binding extends base_resource
{
	...
	* </pre>
	*/
	public void set_denyurl(String denyurl) throws Exception{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appfwprofile_denyurl_binding_response result = (appfwprofile_denyurl_binding_response) service.get_payload_formatter().string_to_resource(appfwprofile_denyurl_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, appfwprofile_denyurl_binding resource) throws Exception {
		appfwprofile_denyurl_binding updateresource = new appfwprofile_denyurl_binding();
	...
	public static base_responses add(nitro_service client, appfwprofile_denyurl_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_denyurl_binding updateresources[] = new appfwprofile_denyurl_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new appfwprofile_denyurl_binding();
				updateresources[i].name = resources[i].name;
				updateresources[i].denyurl = resources[i].denyurl;
	...
	public static base_response delete(nitro_service client, appfwprofile_denyurl_binding resource) throws Exception {
		appfwprofile_denyurl_binding deleteresource = new appfwprofile_denyurl_binding();
		deleteresource.name = resource.name;
		deleteresource.denyurl = resource.denyurl;
		return deleteresource.delete_resource(client);
	}

	public static base_responses delete(nitro_service client, appfwprofile_denyurl_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_denyurl_binding deleteresources[] = new appfwprofile_denyurl_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new appfwprofile_denyurl_binding();
				deleteresources[i].name = resources[i].name;
				deleteresources[i].denyurl = resources[i].denyurl;
			}
	...
	*/
	public static appfwprofile_denyurl_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		appfwprofile_denyurl_binding obj = new appfwprofile_denyurl_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		appfwprofile_denyurl_binding[] response = (appfwprofile_denyurl_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appfwprofile_denyurl_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		appfwprofile_denyurl_binding obj = new appfwprofile_denyurl_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		appfwprofile_denyurl_binding response[] = (appfwprofile_denyurl_binding[]) obj.get_resources(service,option);
		if (response != null) {
