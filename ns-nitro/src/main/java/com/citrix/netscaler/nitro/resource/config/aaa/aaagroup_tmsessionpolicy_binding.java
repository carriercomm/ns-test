...
class aaagroup_tmsessionpolicy_binding_response extends base_response
{
	public aaagroup_tmsessionpolicy_binding[] aaagroup_tmsessionpolicy_binding;
}
/**
	* Binding class showing the tmsessionpolicy that can be bound to aaagroup.
	*/

public class aaagroup_tmsessionpolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		aaagroup_tmsessionpolicy_binding_response result = (aaagroup_tmsessionpolicy_binding_response) service.get_payload_formatter().string_to_resource(aaagroup_tmsessionpolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, aaagroup_tmsessionpolicy_binding resource) throws Exception {
		aaagroup_tmsessionpolicy_binding updateresource = new aaagroup_tmsessionpolicy_binding();
	...
	public static base_responses add(nitro_service client, aaagroup_tmsessionpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			aaagroup_tmsessionpolicy_binding updateresources[] = new aaagroup_tmsessionpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new aaagroup_tmsessionpolicy_binding();
	...
	public static base_response delete(nitro_service client, aaagroup_tmsessionpolicy_binding resource) throws Exception {
		aaagroup_tmsessionpolicy_binding deleteresource = new aaagroup_tmsessionpolicy_binding();
	...
	public static base_responses delete(nitro_service client, aaagroup_tmsessionpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			aaagroup_tmsessionpolicy_binding deleteresources[] = new aaagroup_tmsessionpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new aaagroup_tmsessionpolicy_binding();
	...
	*/
	public static aaagroup_tmsessionpolicy_binding[] get_filtered(nitro_service service, String groupname, String filter) throws Exception{
		aaagroup_tmsessionpolicy_binding obj = new aaagroup_tmsessionpolicy_binding();
		obj.set_groupname(groupname);
		options option = new options();
		option.set_filter(filter);
		aaagroup_tmsessionpolicy_binding[] response = (aaagroup_tmsessionpolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static aaagroup_tmsessionpolicy_binding[] get_filtered(nitro_service service, String groupname, filtervalue[] filter) throws Exception{
		aaagroup_tmsessionpolicy_binding obj = new aaagroup_tmsessionpolicy_binding();
		obj.set_groupname(groupname);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String groupname) throws Exception{
		...
		aaagroup_tmsessionpolicy_binding response[] = (aaagroup_tmsessionpolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
