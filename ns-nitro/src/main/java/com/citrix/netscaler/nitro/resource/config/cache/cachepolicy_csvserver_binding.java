...
class cachepolicy_csvserver_binding_response extends base_response
{
	public cachepolicy_csvserver_binding[] cachepolicy_csvserver_binding;
}
/**
	* Binding class showing the csvserver that can be bound to cachepolicy.
	*/

public class cachepolicy_csvserver_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		cachepolicy_csvserver_binding_response result = (cachepolicy_csvserver_binding_response) service.get_payload_formatter().string_to_resource(cachepolicy_csvserver_binding_response.class, response);
	...
	*/
	public static cachepolicy_csvserver_binding[] get_filtered(nitro_service service, String policyname, String filter) throws Exception{
		cachepolicy_csvserver_binding obj = new cachepolicy_csvserver_binding();
		obj.set_policyname(policyname);
		options option = new options();
		option.set_filter(filter);
		cachepolicy_csvserver_binding[] response = (cachepolicy_csvserver_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static cachepolicy_csvserver_binding[] get_filtered(nitro_service service, String policyname, filtervalue[] filter) throws Exception{
		cachepolicy_csvserver_binding obj = new cachepolicy_csvserver_binding();
		obj.set_policyname(policyname);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String policyname) throws Exception{
		...
		cachepolicy_csvserver_binding response[] = (cachepolicy_csvserver_binding[]) obj.get_resources(service,option);
		if (response != null) {
