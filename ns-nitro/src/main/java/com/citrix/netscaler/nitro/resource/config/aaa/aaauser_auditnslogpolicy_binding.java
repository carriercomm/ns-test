...
class aaauser_auditnslogpolicy_binding_response extends base_response
{
	public aaauser_auditnslogpolicy_binding[] aaauser_auditnslogpolicy_binding;
}
/**
	* Binding class showing the auditnslogpolicy that can be bound to aaauser.
	*/

public class aaauser_auditnslogpolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		aaauser_auditnslogpolicy_binding_response result = (aaauser_auditnslogpolicy_binding_response) service.get_payload_formatter().string_to_resource(aaauser_auditnslogpolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, aaauser_auditnslogpolicy_binding resource) throws Exception {
		aaauser_auditnslogpolicy_binding updateresource = new aaauser_auditnslogpolicy_binding();
	...
	public static base_responses add(nitro_service client, aaauser_auditnslogpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			aaauser_auditnslogpolicy_binding updateresources[] = new aaauser_auditnslogpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new aaauser_auditnslogpolicy_binding();
	...
	public static base_response delete(nitro_service client, aaauser_auditnslogpolicy_binding resource) throws Exception {
		aaauser_auditnslogpolicy_binding deleteresource = new aaauser_auditnslogpolicy_binding();
	...
	public static base_responses delete(nitro_service client, aaauser_auditnslogpolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			aaauser_auditnslogpolicy_binding deleteresources[] = new aaauser_auditnslogpolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new aaauser_auditnslogpolicy_binding();
	...
	*/
	public static aaauser_auditnslogpolicy_binding[] get_filtered(nitro_service service, String username, String filter) throws Exception{
		aaauser_auditnslogpolicy_binding obj = new aaauser_auditnslogpolicy_binding();
		obj.set_username(username);
		options option = new options();
		option.set_filter(filter);
		aaauser_auditnslogpolicy_binding[] response = (aaauser_auditnslogpolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static aaauser_auditnslogpolicy_binding[] get_filtered(nitro_service service, String username, filtervalue[] filter) throws Exception{
		aaauser_auditnslogpolicy_binding obj = new aaauser_auditnslogpolicy_binding();
		obj.set_username(username);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String username) throws Exception{
		...
		aaauser_auditnslogpolicy_binding response[] = (aaauser_auditnslogpolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
