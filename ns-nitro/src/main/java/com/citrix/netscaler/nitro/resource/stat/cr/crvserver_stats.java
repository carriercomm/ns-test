...
{
	public crvserver_stats[] crvserver;
}
/**
...
public class crvserver_stats extends base_resource
{
	...
	*/
	...
	/**
	* <pre>
	* The name of the vserver for which statistics will be displayed.  If not given statistics are shown for all cr vservers.<br> Minimum length =  1
	* </pre>
	*/
	...
	*/
	public static crvserver_stats[] get(nitro_service service) throws Exception{
	...
	* Use this API to fetch the statistics of all crvserver_stats resources that are configured on netscaler.
	*/
	public static crvserver_stats[] get(nitro_service service, options option) throws Exception{
		crvserver_stats obj = new crvserver_stats();
		crvserver_stats[] response = (crvserver_stats[])obj.stat_resources(service,option);
		return response;
	}
	...
	*/
	public static crvserver_stats get(nitro_service service, String name) throws Exception{
		crvserver_stats obj = new crvserver_stats();
		obj.set_name(name);
