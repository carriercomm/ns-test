...
public class nshttpparam extends base_resource
{
	...
	/**
	* <pre>
	* Whether to drop invalid HTTP requests/responses.<br> Default value: OFF<br> Possible values = ON, OFF
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Whether to mark HTTP/0.9 requests as invalid.<br> Default value: OFF<br> Possible values = ON, OFF
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Whether to mark CONNECT requests as invalid.<br> Default value: OFF<br> Possible values = ON, OFF
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Enable/disable NetScaler server header insertion for NetScaler generated HTTP responses.<br> Default value: OFF<br> Possible values = ON, OFF
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Whether to log HTTP error responses generated by NetScaler.<br> Default value: ON<br> Possible values = ON, OFF
	* </pre>
	*/
	...
	*/
	public static base_response unset(nitro_service client, nshttpparam resource, String[] args) throws Exception{
		...
		unsetresource.insnssrvrhdr = resource.insnssrvrhdr;
		unsetresource.nssrvrhdr = resource.nssrvrhdr;
		unsetresource.logerrresp = resource.logerrresp;
