...
b) Activex Control - ActiveX control run by Microsoft's Internet Explorer.<br> Possible values = AGENT, PLUGIN
	...
	*/
	...
	/**
	* <pre>
	* Force a disconnection from the Access Gateway Plug-in with Access Gateway after a specified number of minutes. If the session closes, the user must log on again.<br> Minimum value =  1<br> Maximum value =  3000
	* </pre>
	*/
