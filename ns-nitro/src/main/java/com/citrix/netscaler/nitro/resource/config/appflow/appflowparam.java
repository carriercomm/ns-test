...
public class appflowparam extends base_resource
{
	...
	*/
	...
	/**
	* <pre>
	* Interval, in seconds, at which to send flow records to the configured collectors.<br> Default value: 600<br> Minimum value =  60<br> Maximum value =  3600
	* </pre>
	*/
	...
	*/
	...
	/**
	* <pre>
	* Enable AppFlow ICA traffic logging.<br> Default value: DISABLED<br> Possible values = ENABLED, DISABLED
	* </pre>
	*/
	public void set_icatraffic(String icatraffic) throws Exception{
		this.icatraffic = icatraffic;
	}
	...
	* </pre>
	*/
	public String get_icatraffic() throws Exception {
		return this.icatraffic;
	}
	...
	*/
	public static base_response update(nitro_service client, appflowparam resource) throws Exception {
		...
		updateresource.icatraffic = resource.icatraffic;
	...
	*/
	...
	public static class icatrafficEnum {
		public static final String ENABLED = "ENABLED";
		public static final String DISABLED = "DISABLED";
	}
