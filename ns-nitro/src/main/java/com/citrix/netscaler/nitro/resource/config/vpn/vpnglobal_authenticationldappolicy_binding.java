...
class vpnglobal_authenticationldappolicy_binding_response extends base_response
{
	public vpnglobal_authenticationldappolicy_binding[] vpnglobal_authenticationldappolicy_binding;
}
/**
	* Binding class showing the authenticationldappolicy that can be bound to vpnglobal.
	*/

public class vpnglobal_authenticationldappolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		vpnglobal_authenticationldappolicy_binding_response result = (vpnglobal_authenticationldappolicy_binding_response) service.get_payload_formatter().string_to_resource(vpnglobal_authenticationldappolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, vpnglobal_authenticationldappolicy_binding resource) throws Exception {
		vpnglobal_authenticationldappolicy_binding updateresource = new vpnglobal_authenticationldappolicy_binding();
	...
	public static base_responses add(nitro_service client, vpnglobal_authenticationldappolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			vpnglobal_authenticationldappolicy_binding updateresources[] = new vpnglobal_authenticationldappolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new vpnglobal_authenticationldappolicy_binding();
	...
	public static base_response delete(nitro_service client, vpnglobal_authenticationldappolicy_binding resource) throws Exception {
		vpnglobal_authenticationldappolicy_binding deleteresource = new vpnglobal_authenticationldappolicy_binding();
		deleteresource.policyname = resource.policyname;
		deleteresource.secondary = resource.secondary;
		return deleteresource.delete_resource(client);
	}

	public static base_responses delete(nitro_service client, vpnglobal_authenticationldappolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			vpnglobal_authenticationldappolicy_binding deleteresources[] = new vpnglobal_authenticationldappolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new vpnglobal_authenticationldappolicy_binding();
