...
class vrid6_nsip6_binding_response extends base_response
{
	public vrid6_nsip6_binding[] vrid6_nsip6_binding;
}
/**
	* Binding class showing the nsip6 that can be bound to vrid6.
	*/

public class vrid6_nsip6_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		vrid6_nsip6_binding_response result = (vrid6_nsip6_binding_response) service.get_payload_formatter().string_to_resource(vrid6_nsip6_binding_response.class, response);
	...
	*/
	public static vrid6_nsip6_binding[] get_filtered(nitro_service service, Long id, String filter) throws Exception{
		vrid6_nsip6_binding obj = new vrid6_nsip6_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
		vrid6_nsip6_binding[] response = (vrid6_nsip6_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static vrid6_nsip6_binding[] get_filtered(nitro_service service, Long id, filtervalue[] filter) throws Exception{
		vrid6_nsip6_binding obj = new vrid6_nsip6_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, Long id) throws Exception{
		...
		vrid6_nsip6_binding response[] = (vrid6_nsip6_binding[]) obj.get_resources(service,option);
		if (response != null) {
