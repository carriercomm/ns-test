...
class vlan_interface_binding_response extends base_response
{
	public vlan_interface_binding[] vlan_interface_binding;
}
/**
...
public class vlan_interface_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		vlan_interface_binding_response result = (vlan_interface_binding_response) service.get_payload_formatter().string_to_resource(vlan_interface_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, vlan_interface_binding resource) throws Exception {
		vlan_interface_binding updateresource = new vlan_interface_binding();
	...
	public static base_responses add(nitro_service client, vlan_interface_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			vlan_interface_binding updateresources[] = new vlan_interface_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new vlan_interface_binding();
	...
	public static base_response delete(nitro_service client, vlan_interface_binding resource) throws Exception {
		vlan_interface_binding deleteresource = new vlan_interface_binding();
	...
	public static base_responses delete(nitro_service client, vlan_interface_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			vlan_interface_binding deleteresources[] = new vlan_interface_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new vlan_interface_binding();
	...
	*/
	public static vlan_interface_binding[] get_filtered(nitro_service service, Long id, String filter) throws Exception{
		vlan_interface_binding obj = new vlan_interface_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
		vlan_interface_binding[] response = (vlan_interface_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static vlan_interface_binding[] get_filtered(nitro_service service, Long id, filtervalue[] filter) throws Exception{
		vlan_interface_binding obj = new vlan_interface_binding();
		obj.set_id(id);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, Long id) throws Exception{
		...
		vlan_interface_binding response[] = (vlan_interface_binding[]) obj.get_resources(service,option);
		if (response != null) {
