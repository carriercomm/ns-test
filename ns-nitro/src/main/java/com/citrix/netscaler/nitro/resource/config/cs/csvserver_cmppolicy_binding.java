...
class csvserver_cmppolicy_binding_response extends base_response
{
	public csvserver_cmppolicy_binding[] csvserver_cmppolicy_binding;
}
/**
	* Binding class showing the cmppolicy that can be bound to csvserver.
	*/

public class csvserver_cmppolicy_binding extends base_resource
{
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		csvserver_cmppolicy_binding_response result = (csvserver_cmppolicy_binding_response) service.get_payload_formatter().string_to_resource(csvserver_cmppolicy_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, csvserver_cmppolicy_binding resource) throws Exception {
		csvserver_cmppolicy_binding updateresource = new csvserver_cmppolicy_binding();
	...
	public static base_responses add(nitro_service client, csvserver_cmppolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			csvserver_cmppolicy_binding updateresources[] = new csvserver_cmppolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new csvserver_cmppolicy_binding();
	...
	public static base_response delete(nitro_service client, csvserver_cmppolicy_binding resource) throws Exception {
		csvserver_cmppolicy_binding deleteresource = new csvserver_cmppolicy_binding();
	...
	public static base_responses delete(nitro_service client, csvserver_cmppolicy_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			csvserver_cmppolicy_binding deleteresources[] = new csvserver_cmppolicy_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new csvserver_cmppolicy_binding();
	...
	*/
	public static csvserver_cmppolicy_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		csvserver_cmppolicy_binding obj = new csvserver_cmppolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		csvserver_cmppolicy_binding[] response = (csvserver_cmppolicy_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static csvserver_cmppolicy_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		csvserver_cmppolicy_binding obj = new csvserver_cmppolicy_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		csvserver_cmppolicy_binding response[] = (csvserver_cmppolicy_binding[]) obj.get_resources(service,option);
		if (response != null) {
