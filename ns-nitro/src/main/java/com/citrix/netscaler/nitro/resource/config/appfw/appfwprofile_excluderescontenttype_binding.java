...
class appfwprofile_excluderescontenttype_binding_response extends base_response
{
	public appfwprofile_excluderescontenttype_binding[] appfwprofile_excluderescontenttype_binding;
}
/**
	* Binding class showing the excluderescontenttype that can be bound to appfwprofile.
	*/

public class appfwprofile_excluderescontenttype_binding extends base_resource
{
	private String excluderescontenttype;
	...
	* </pre>
	*/
	public void set_excluderescontenttype(String excluderescontenttype) throws Exception{
	...
	* </pre>
	*/
	public String get_excluderescontenttype() throws Exception {
		return this.excluderescontenttype;
	}
	...
	*/
	protected base_resource[] get_nitro_response(nitro_service service, String response) throws Exception{
		appfwprofile_excluderescontenttype_binding_response result = (appfwprofile_excluderescontenttype_binding_response) service.get_payload_formatter().string_to_resource(appfwprofile_excluderescontenttype_binding_response.class, response);
	...
	*/
	...
	public static base_response add(nitro_service client, appfwprofile_excluderescontenttype_binding resource) throws Exception {
		appfwprofile_excluderescontenttype_binding updateresource = new appfwprofile_excluderescontenttype_binding();
	...
	public static base_responses add(nitro_service client, appfwprofile_excluderescontenttype_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_excluderescontenttype_binding updateresources[] = new appfwprofile_excluderescontenttype_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				updateresources[i] = new appfwprofile_excluderescontenttype_binding();
				updateresources[i].name = resources[i].name;
				updateresources[i].excluderescontenttype = resources[i].excluderescontenttype;
	...
	public static base_response delete(nitro_service client, appfwprofile_excluderescontenttype_binding resource) throws Exception {
		appfwprofile_excluderescontenttype_binding deleteresource = new appfwprofile_excluderescontenttype_binding();
		deleteresource.name = resource.name;
		deleteresource.excluderescontenttype = resource.excluderescontenttype;
		return deleteresource.delete_resource(client);
	}

	public static base_responses delete(nitro_service client, appfwprofile_excluderescontenttype_binding resources[]) throws Exception {
		base_responses result = null;
		if (resources != null && resources.length > 0) {
			appfwprofile_excluderescontenttype_binding deleteresources[] = new appfwprofile_excluderescontenttype_binding[resources.length];
			for (int i=0;i<resources.length;i++){
				deleteresources[i] = new appfwprofile_excluderescontenttype_binding();
				deleteresources[i].name = resources[i].name;
				deleteresources[i].excluderescontenttype = resources[i].excluderescontenttype;
			}
	...
	*/
	public static appfwprofile_excluderescontenttype_binding[] get_filtered(nitro_service service, String name, String filter) throws Exception{
		appfwprofile_excluderescontenttype_binding obj = new appfwprofile_excluderescontenttype_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
		appfwprofile_excluderescontenttype_binding[] response = (appfwprofile_excluderescontenttype_binding[]) obj.getfiltered(service, option);
		return response;
	}
	...
	*/
	public static appfwprofile_excluderescontenttype_binding[] get_filtered(nitro_service service, String name, filtervalue[] filter) throws Exception{
		appfwprofile_excluderescontenttype_binding obj = new appfwprofile_excluderescontenttype_binding();
		obj.set_name(name);
		options option = new options();
		option.set_filter(filter);
	...
	*/
	public static long count(nitro_service service, String name) throws Exception{
		...
		appfwprofile_excluderescontenttype_binding response[] = (appfwprofile_excluderescontenttype_binding[]) obj.get_resources(service,option);
		if (response != null) {
